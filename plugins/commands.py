    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            if f_caption is None:
                f_caption = f"{title}"
            try:
                h = await message.reply_text(f"<b><u>This Movie File/Video will be deleted in <b><u>{AUTO_DELETE} minutes</b>")
...
# Ask Doubt on telegram @KingVJ01
        ...
        async for msg in client.iter_messages(int(f_chat_id), int(l_msg_id), int(f_msg_id)):
            if msg.media:
                ...
                try:
                    h = await message.reply_text(f"<b>This Movie File/Video will be deleted in <b><u>{AUTO_DELETE} minutes</u> </b>")
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(f"<b><u>  File/Video will be deleted in <b><u>{AUTO_DELETE} mins</u> 🫥 <i></b>",quote=True)
            await asyncio.sleep(AUTO_DELETE_TIME)
            await msg.delete()
            await g.delete()
